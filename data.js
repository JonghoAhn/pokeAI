...
const OPPONENT_POOL = [
    // 쉬운 포켓몬 추가
    { id: 'rattata', name: '꼬렛', hp: 80, maxHp: 80, img: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/19.png', types: ['노말'], skills: [{ name: '몸통박치기', power: 20, type: '노말' }, { name: '전광석화', power: 25, type: '노말' }] },
    { id: 'pidgey', name: '구구', hp: 85, maxHp: 85, img: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/16.png', types: ['노말', '비행'], skills: [{ name: '공중날기', power: 20, type: '비행' }, { name: '몸통박치기', power: 20, type: '노말' }] },
    { id: 'clefairy', name: '삐삐', hp: 90, maxHp: 90, img: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/35.png', types: ['페어리'], skills: [{ name: '몸통박치기', power: 20, type: '노말' }, growlSkill] },
    // 기존 포켓몬
    ...
    { id: 'nidoking', name: '니드킹', hp: 120, maxHp: 120, img: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/34.png', types: ['독', '땅'], skills: [{ name: '지진', power: 30, type: '땅' }, { name: '독엄니', power: 25, type: '독' }, growlSkill] },
    { id: 'arcanine', name: '윈디', hp: 150, maxHp: 150, img: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/59.png', types: ['불'], skills: [{ name: '화염방사', power: 30, type: '불' }, { name: '이판사판태클', power: 35, type: '노말' }] },
    { id: 'rhydon', name: '코뿌리', hp: 130, maxHp: 130, img: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/112.png', types: ['땅', '바위'], skills: [{ name: '스톤샤워', power: 25, type: '바위' }, { name: '지진', power: 30, type: '땅' }] },
    { id: 'lapras', name: '라프라스', hp: 160, maxHp: 160, img: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/131.png', types: ['물', '얼음'], skills: [{ name: '냉동빔', power: 35, type: '얼음' }, { name: '파도타기', power: 30, type: '물' }] },
    { id: 'jolteon', name: '쥬피썬더', hp: 140, maxHp: 140, img: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/135.png', types: ['전기'], skills: [{ name: '번개', power: 40, type: '전기' }, { name: '전광석화', power: 25, type: '노말' }] },
    { id: 'exeggutor', name: '나시', hp: 140, maxHp: 140, img: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/103.png', types: ['풀', '에스퍼'], skills: [{ name: '솔라빔', power: 40, type: '풀' }, { name: '사이코키네시스', power: 35, type: '에스퍼' }] },
    { id: 'tyranitar', name: '마기라스', hp: 200, maxHp: 200, img: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/248.png', types: ['바위', '악'], skills: [{ name: '스톤에지', power: 40, type: '바위' }, { name: '깨물어부수기', power: 35, type: '악' }] },
    { id: 'articuno', name: '프리져', hp: 180, maxHp: 180, img: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/144.png', types: ['얼음', '비행'], skills: [{ name: '눈보라', power: 45, type: '얼음' }, { name: '폭풍', power: 40, type: '비행' }] },
    { id: 'zapdos', name: '썬더', hp: 180, maxHp: 180, img: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/145.png', types: ['전기', '비행'], skills: [{ name: '번개', power: 45, type: '전기' }, { name: '공중날기', power: 30, type: '비행' }] },
    { id: 'moltres', name: '파이어', hp: 180, maxHp: 180, img: 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/146.png', types: ['불', '비행'], skills: [{ name: '불대문자', power: 45, type: '불' }, { name: '폭풍', power: 40, type: '비행' }] }
];
...
const POKEMON_LEARNSETS = {
    'pikachu': ['10만볼트', '번개', '전광석화', '이판사판태클'],
    'bulbasaur': ['잎날가르기', '솔라빔', '오물폭탄', '몸통박치기'],
    'charmander': ['화염방사', '불대문자', '드래곤크루', '깨물어부수기'],
    'squirtle': ['파도타기', '하이드로펌프', '냉동빔', '깨물어부수기'],
    'machamp': ['인파이트', '엄청난힘', '스톤샤워', '지진'],
    'alakazam': ['사이코키네시스', '미래예지', '섀도볼', '칼춤'],
    'gengar': ['섀도볼', '병상첨병', '오물폭탄', '사이코키네시스'],
    'gyarados': ['파도타기', '하이드로펌프', '폭풍', '깨물어부수기'],
    'snorlax': ['이판사판태클', '파괴광선', '지진', '깨물어부수기'],
    'dragonite': ['드래곤크루', '용성군', '폭풍', '파괴광선'],
    'metagross': ['코멧펀치', '아이언헤드', '사이코키네시스', '지진'],
    'lucario': ['인파이트', '코멧펀치', '아이언헤드', '섀도볼']
};
